...
if __name__ == "__main__":
	...
	parser.add_argument("--max_output_size", default=100, type=int, help="Maximum size of each output file size. (bytes)")
	...
	parser.add_argument("--total_parsed_data_size", default=100000, type=int, help="The Maximum parsed Data allowed in (bytes)")
